...
var Middleware = /** @class */ (function () {
    ...
    Middleware.prototype.register = function (name, object) {
    ...
    Middleware.prototype.process = function (req, res, next) {
        ...
        var json = JSON.stringify(obj.data, null, 2);
...
;
	...
	if (isObject(_src_server_Middleware) && isObject(module.exports)) {
		Object.assign(_src_server_Middleware, module.exports);
		return;
	}
	_src_server_Middleware = module.exports;
}());
// end:source ./ModuleSimplified.js
...
var Middleware_1 = _src_server_Middleware;
var servers = {};
var Server = /** @class */ (function () {
    function Server() {
        this.middleware = new Middleware_1.Middleware();
    }
    Server.prototype.register = function (name, object) {
    ...
    Server.prototype.start = function (port) {
        ...
        http
            ...
            _this.middleware.process(req, res, function () {
                res.statusCode = 404;
                res.end();
            });
        })
    ...
    Server.create = function (port) {
        var _a;
        return (_a = servers[port]) !== null && _a !== void 0 ? _a : (servers[port] = new Server().start(port));
    };
    return Server;
}());
...
;
	...
	if (isObject(_src_server_Server) && isObject(module.exports)) {
...
var MemSync = /** @class */ (function (_super) {
    ...
    function MemSync(name, defaultObject, options) {
        ...
        if ((_b = options === null || options === void 0 ? void 0 : options.server) === null || _b === void 0 ? void 0 : _b.port) {
            Server_1.Server.create(options.server.port).register(name, _this.ipc.shared);
        }
        return _this;
    }
