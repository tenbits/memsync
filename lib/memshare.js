...
var IpcClient = /** @class */ (function (_super) {
    ...
    function IpcClient(pipeName, clientId, clientOptions) {
        ...
        _this.channelName = "memshare_".concat(pipeName);
        return _this;
    }
...
var IpcHost = /** @class */ (function (_super) {
    ...
    IpcHost.prototype.create = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ipc.config.id = "memshare_".concat(_this.pipeName);
            ipc.config.silent = true;
            ipc.serve(function () {
...
var MemShare = /** @class */ (function (_super) {
    __extends(MemShare, _super);
    function MemShare(name, defaultObject, options) {
    ...
    MemShare.prototype.onceAsync = function (event) {
        return __awaiter(this, void 0, Promise, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
    ...
    MemShare.prototype.observe = function (property, cb) {
        this.ipc.shared.observe(property, cb);
        return this;
    };
    MemShare.prototype.getStatus = function () {
        return this.ipc.getStatus();
    };
    MemShare.prototype.setOptions = function (opts) {
    };
    return MemShare;
}(atma_utils_1.class_EventEmitter));
