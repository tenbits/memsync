...
var _node_modules_node_ipc_node_ipc = {};
var _src_Channel = {};
...
;
	...
	if (isObject(_node_modules_node_ipc_node_ipc) && isObject(module.exports)) {
		Object.assign(_node_modules_node_ipc_node_ipc, module.exports);
		return;
	}
	_node_modules_node_ipc_node_ipc = module.exports;
}());
// end:source ./ModuleSimplified.js
...
var ipc = _node_modules_node_ipc_node_ipc;
...
var IpcClient = /** @class */ (function (_super) {
    ...
    function IpcClient(pipeName, clientId, clientOptions) {
        ...
        _this.channelName = "memshare_" + pipeName;
        return _this;
    }
    ...
    IpcClient.prototype.connect = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            ipc.config.id = "client_" + _this.clientId;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (remote.timestamp > this.shared.timestamp) {
                            this.shared.version = remote.version;
                            this.shared.timestamp = remote.timestamp;
                            this.shared.data = remote.data;
                        }
...
var IpcHost = /** @class */ (function (_super) {
    ...
    IpcHost.prototype.create = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ipc.config.id = "memshare_" + _this.pipeName;
            ipc.config.silent = true;
            ipc.serve(function () {
    ...
    IpcHost.prototype.processRpc = function (message) {
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        fn = atma_utils_1.obj_getProperty((_a = this.rpcHandlers) !== null && _a !== void 0 ? _a : {}, message.method);
                        if (typeof fn !== 'function') {
                            return [2 /*return*/, { error: new Error(message.method + " is not a function") }];
                        }
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fn.call.apply(fn, __spreadArrays([null], (Array.isArray(message.data) ? message.data : [message.data])))];
                    case 2:
                        result = _b.sent();
...
(function () {
	...
	"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.obj_isPatch = exports.obj_patchValidate = exports.obj_partialToUpdateQuery = exports.obj_patchConflict = exports.obj_patch = void 0;
var atma_utils_1 = require("atma-utils");
        ...
        _this.rpc = {
            sync: function (message) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    this.shared.version = message.version;
                    this.shared.data = message.data;
                    return [2 /*return*/, null];
                });
            }); },
            patch: function (message) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    if (this.localVersion > message.netVersion) {
                        ...
                        conflict = alot_1.default(patches).map(function (patch) {
                            return alot_1.default(message.patches).map(function (p) {
                                return patch_1.obj_patchConflict(patch.patch, p.patch);
...
var SharedObject = /** @class */ (function () {
    ...
    SharedObject.prototype.patch = function (update, version) {
        ...
        patch_1.obj_patch(this.data, update);
        return patch;
    };
...
var IpcPipe = /** @class */ (function (_super) {
    ...
    IpcPipe.prototype.stop = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, ((_a = this.channel) === null || _a === void 0 ? void 0 : _a.close())];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    IpcPipe.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.status == null)) return [3 /*break*/, 2];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 4:
                        error_1 = _e.sent();
                        this.emit('startingFailed', type, error_1);
                        this.status = 'none';
    ...
    IpcPipe.prototype.emit = function (event) {
        ...
        console.log.apply(console, __spreadArrays(["Pipe " + this.status, event], args));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MemShare = void 0;
var IpcPipe_1 = _src_IpcPipe;
var MemShare = /** @class */ (function () {
    function MemShare(name, defaultObject) {
        if (defaultObject === void 0) { defaultObject = null; }
        var _a;
        this.name = name;
        this.defaultObject = defaultObject;
        this.pipe = new IpcPipe_1.IpcPipe(this.name, (_a = this.defaultObject) !== null && _a !== void 0 ? _a : {});
        this.data = this.pipe.shared.data;
    }
    MemShare.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pipe.start()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    MemShare.prototype.stop = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pipe.stop()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    MemShare.prototype.patch = function (patch) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pipe.patch(patch)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
;
	...
	if (isObject(_src_MemShare) && isObject(module.exports)) {
		Object.assign(_src_MemShare, module.exports);
		return;
	}
	_src_MemShare = module.exports;
}());
// end:source ./ModuleSimplified.js

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var MemShare_1 = _src_MemShare;
Object.defineProperty(exports, "MemShare", { enumerable: true, get: function () { return MemShare_1.MemShare; } });
